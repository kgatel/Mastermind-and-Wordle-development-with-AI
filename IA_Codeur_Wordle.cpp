...
string IA_Codeur_Wordle :: choixFichier(string mot) {
...
bool IA_Codeur_Wordle :: VerifierEntree(string entree) {
	FonctionsUtiles f;
	string chemin;
...
Combinaison IA_Codeur_Wordle :: entrerCode() {
    string mot;
    bool t=false;
...
string IA_Codeur_Wordle :: cachermot(bool longueurMotBonne,bool motExiste){
	string mot="";
	int a;
    bool entr=false;
    initscr();
